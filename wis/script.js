...
document.querySelector("#contact-form").addEventListener("submit", function (event) {
    ...
    emailjs.init("ygftUv0ONTNc5yIUh"); // Înlocuiește cu cheia publică din contul tău EmailJS
    ...
    const params = {
        ...
        mesaj: document.getElementById("mesaj").value, // Asigură-te că textarea are id-ul "mesaj"
    };

    // Specifică ID-ul serviciului și al șablonului
    const serviceID = "service_z2riqfn"; // Înlocuiește cu Service ID din EmailJS
    const templateID = "template_1nyr5zq"; // Înlocuiește cu Template ID din EmailJS

    // Trimite emailul
    emailjs.send(serviceID, templateID, params)
        .then((res) => {
            alert(`Mulțumesc, ${params.sendername}! Mesajul tău a fost trimis.`);
